...
#ifndef __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION____QUEX____CALC_LEXER
#define __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION____QUEX____CALC_LEXER
...
#define QUEX_SETTING_VERSION           "0.58.2"
#define QUEX_SETTING_BUILD_DATE        "Thu Mar 24 02:42:24 2011"
...
#   define QUEX_NAME(NAME)             Calc_lexer_ ## NAME
...
#   define QUEX_MEMBER(NAME)           Calc_lexer::NAME                
#endif

/* For the utf8 printing: Name the function that converts the 
 * specific codec to utf8 representation.                       */
#ifndef    QUEX_SETTING_CODEC   
#   define QUEX_SETTING_CODEC          unicode
#endif
...
#   define QUEX_TYPE_ANALYZER                struct Calc_lexer_tag
#   define QUEX_TYPE0_ANALYZER               struct Calc_lexer_tag
#   define QUEX_TYPE_DERIVED_ANALYZER        struct Calc_lexer_tag
 ...
 * and token.                                                        */
#   define QUEX_TYPE_ANALYZER                ::quex::Calc_lexer
#   define QUEX_TYPE0_ANALYZER               Calc_lexer
#   define QUEX_TYPE_DERIVED_ANALYZER        Calc_lexer
...
#endif /* __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION____QUEX____CALC_LEXER */
